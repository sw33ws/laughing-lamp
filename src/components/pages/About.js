...
export default function About() {
  return (
    ...
    <div className='col'>
      <img alt='Me"' className='ProfileImage' id="A image of me"src={img}/>
    </div>
    <div className='col'>
      ...
      <p className='AboutMe-text'>
        ...
        During my time  at the  University of Toronto I learned a large array of programming skills,<br></br>
